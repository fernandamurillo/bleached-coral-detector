...
def get_yolo_net(cfg_path, weight_path):
    ...
    # cfg_path = '/projects/8b6ba5ff-b5a6-4fd9-8e5c-409413b72486/darknet/nvidia/nvidia.cfg'
    # weight_path = '/projects/8b6ba5ff-b5a6-4fd9-8e5c-409413b72486/darknet/backup/nvidia_final.weights'
